    ...
    >
      <View style={styles.categories}>
        ...
        <View style={styles.extension}>
          ...
          >
            <Icon2 name="filetext1" size={20} color="#000" />
        ...
        <View style={styles.extension}>
          ...
          >
            ...
            <Text style={styles.uploadText}>Favorites</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.uploadContent}
            onPress={() => setShowModal(false)}
          >
            <Icon2 name="search1" size={20} color="#000" />
            <Text style={styles.uploadText}>Search</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.uploadContent}
            onPress={() => {
          ...
          >
            <Icon2 name="arrowsalt" size={20} color="#000" />
            <Text style={styles.uploadText}>All Files</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      {showModal && (
        <Upload
          visible={showModal}
          closeUpload={() => setShowModal(false)}
